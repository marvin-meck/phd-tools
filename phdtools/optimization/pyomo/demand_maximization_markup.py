...
def create_abstract_model():
    ...
    model = BaseModel("Demand maximization with constant markup")

    add_consumer_preference_model(model)

    model.MARKUP = pyo.Param()

    @model.Constraint()
    def markup_constr(block):
        return block.MARKUP * block.variableCostsEuro <= block.priceEuro
